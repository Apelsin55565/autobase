 ...
 */
public class DriversWithoutAutoCommand implements ActionCommand {
    ...
    public String execute(HttpServletRequest request) {
        ...
        request.getSession().setAttribute("users",usersDAO.DriversWithoutAuto());


        return ConfigurationManager.getProperty("path.page.createnewauto");
    }
}
